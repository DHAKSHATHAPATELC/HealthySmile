...
.text {
	...
	background: linear-gradient(to right, #7e11d1 0%, #330867 100%);
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger"  href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp Healthy Smile</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif; background-image: none; ">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSk6j5cDMUPKlIbeirb9aslDunJKdtSbBg6sQ&usqp=CAU alt=""/>
                        <h3>Welcome</h3>
