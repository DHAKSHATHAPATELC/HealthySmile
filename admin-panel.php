...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Healthy Smile</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Healthy Smile</a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #e476f5, #9de3d5);
}
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    ...
    <marquee behaviour="scroll" direction="left" scrollamount="5"> <h5 style=" color: #e05873; font-style: italic"> If you registred for the 1st time Kindly Logout And Re-Login</h5></marquee> 
   </h3>
    <div class="row">
